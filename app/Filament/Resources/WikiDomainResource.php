...
use App\Filament\Resources\WikiDomainResource\Pages;
use App\Filament\Resources\WikiDomainResource\RelationManagers;
...
class WikiDomainResource extends Resource
{
    protected static ?string $model = WikiDomain::class;
    ...
    {
        return [
            'index' => Pages\ListWikiDomains::route('/'),
            'create' => Pages\CreateWikiDomain::route('/create'),
            'edit' => Pages\EditWikiDomain::route('/{record}/edit'),
        ];
    }
}
