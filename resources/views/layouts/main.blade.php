    ...
    <header class="fixed w-full top-0 z-50 bg-white dark:bg-slate-900 shadow-md transition-colors duration-300">
        <div class="container mx-auto px-6 py-2 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- Join IVAO CTA / User Menu -->
                @guest
                    <a href="{{ route('auth.ivao.redirect') }}"
                        class="hidden md:block bg-ivao-blue text-white hover:bg-blue-800 dark:bg-white dark:text-ivao-blue dark:hover:bg-slate-100 px-5 py-2 rounded-full font-bold text-sm shadow-sm transition-all duration-200 uppercase tracking-wide">
                        Log in
                    </a>
                @else
                    <div class="relative group hidden md:block" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="flex items-center space-x-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 px-4 py-2 rounded-full transition-all">
                            <div
                                class="w-8 h-8 rounded-full bg-ivao-blue text-white flex items-center justify-center font-bold text-xs uppercase overflow-hidden border-2 border-white dark:border-slate-700 shadow-sm relative">
                                <span class="relative z-10">{{ substr(Auth::user()->name, 0, 1) }}</span>
                            </div>
                            <span
                                class="text-sm font-bold text-slate-700 dark:text-slate-200 pr-1">{{ explode(' ', Auth::user()->name)[0] }}</span>
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute right-0 mt-3 w-56 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 py-2 z-[100] transform transition-all"
                            x-transition:enter="transition ease-out duration-100"
                            x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100">

                            <div class="px-4 py-3 border-b border-slate-50 dark:border-slate-700/50 mb-1">
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-0.5">IVAO Member</p>
                                <p class="text-sm font-bold text-slate-900 dark:text-white truncate">
                                    #{{ Auth::user()->vid }}</p>
                            </div>

                            <a href="https://ivao.aero/members/person/details5.asp?Id={{ Auth::user()->vid }}"
                                target="_blank"
                                class="flex items-center px-4 py-2.5 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 hover:text-ivao-blue dark:hover:text-white transition-colors">
                            ...
                            @if(Auth::user()->vid == '710267' || Auth::user()->email == 'abdellah.c@ivao.aero')
                                <a href="/admin"
                                    class="flex items-center px-4 py-2.5 text-sm font-bold text-ma-red hover:bg-ma-red/5 transition-colors">
                                    <svg class="w-4 h-4 mr-3 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z">
                                        </path>
                            ...
                            <div class="border-t border-slate-50 dark:border-slate-700/50 mt-1 pt-1">
                                <form action="{{ route('auth.ivao.logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="w-full flex items-center px-4 py-2.5 text-sm text-slate-500 hover:text-ma-red dark:hover:text-ma-red transition-colors">
            ...
            <div class="grid md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex items-center space-x-5">
                        <a href="https://www.facebook.com/IVAOMorocco" target="_blank"
                            class="text-slate-400 hover:text-[#1877F2] transition-colors" title="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/ivao_morocco" target="_blank"
                            class="text-slate-400 hover:text-[#E4405F] transition-colors" title="Instagram">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://x.com/IVAOMorocco" target="_blank"
                        ...
                        <a href="https://www.youtube.com/@IVAOMorocco" target="_blank"
                            class="text-slate-400 hover:text-[#FF0000] transition-colors" title="YouTube">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="https://github.com/IVAO-MA" target="_blank"
                            class="text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
                            title="GitHub">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
