...
@section('content')
    <div class="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
        ...
        <div
            class="relative bg-gradient-to-br from-ivao-blue to-blue-900 dark:from-slate-900 dark:to-slate-950 pt-32 pb-56 px-6">
            <!-- Decorative Elements -->
            <div class="absolute top-0 right-0 w-1/3 h-full opacity-20 pointer-events-none">
                <img src="https://www.ivao.aero/publrelat/branding/svg_logos/MA.svg"
                    class="w-full h-full object-contain scale-150 grayscale brightness-150">
            </div>
            ...
            <div class="container mx-auto max-w-6xl relative z-10">
                <div class="flex flex-col md:flex-row items-center md:items-end gap-8">
                    ...
                    <!-- Quick Stats Badges -->
                    <div class="hidden lg:flex gap-6 self-center">
                        <img src="https://ivao.aero/data/images/ratings/atc/{{ $user->rating_atc }}.gif"
                            class="h-7 opacity-90 drop-shadow-lg">
